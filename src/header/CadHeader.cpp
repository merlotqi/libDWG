...
#include <dwg/attributes/CadSystemVariableAttribute.h>
...
RTTR_REGISTRATION
{
    ...
    registration::class_<CadHeader>("CadHeader")
            ...
            .property("createEllipseAsPolyline", &CadHeader::createEllipseAsPolyline, &CadHeader::setCreateEllipseAsPolyline)(metadata("CadSystemVariable", CadSystemVariableAttribute(CadSystemVariables::ELLIPSE, {70})))
