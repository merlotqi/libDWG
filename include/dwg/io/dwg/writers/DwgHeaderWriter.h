...
{
public
    override string SectionName = > DwgSectionDefinition.Header;

private
    MemoryStream _msmain;
...
public
    DwgHeaderWriter(Stream stream, CadDocument document, Encoding encoding)
        : base(document.Header.Version)
    {
        ...
        this._startWriter = DwgStreamWriterBase.GetStreamWriter(
                _version, stream, this._encoding);

        this._msmain = new MemoryStream();
        this._writer = DwgStreamWriterBase.GetStreamWriter(
                _version, this._msmain, this._encoding);
    }
...
public
    void Write()
    {
        ...
        {
            //Setup the writers
            this._writer = DwgStreamWriterBase.GetMergedWriter(
                    _version, this._msmain, this._encoding);
        ...
        //B : PSLTSCALE
        this._writer.WriteBit(this._header.PaperSpaceLineTypeScaling ==
        ...
        //B : ANGDIR
        this._writer.WriteBit(this._header.AngularDirection !=
                              Types.Units.AngularDirection.CounterClockWise);
        //B : SPLFRAME
        ...
        //B : VISRETAIN
        this._writer.WriteBit(
                this._header.RetainXRefDependentVisibilitySettings);
        ...
        //BS: PROXYGRAPHICS
        this._writer.WriteBitShort(
                (short) (this._header.ProxyGraphics ? 1 : 0));
        ...
        //BS : SHADEDIF
        this._writer.WriteBitShort(
                this._header.ShadeDiffuseToAmbientPercentage);
        //BS: UNITMODE
        ...
        //BS : CMLJUST
        this._writer.WriteBitShort(
                (short) this._header.CurrentMultilineJustification);
        //BS : TEXTQLTY
        ...
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._header.CurrentLayer);

        //H: TEXTSTYLE(hard pointer)
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._header.CurrentTextStyle);

        //H: CELTYPE(hard pointer)
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._header.CurrentLineType);
        ...
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._header.DimensionStyleOverrides);
        ...
        if (this.R2000Plus)
        {
            ...
            this._writer.WriteBitDouble(
                    this._header.ViewportDefaultViewScaleFactor);
        }
        ...
        if (this.R2000Plus)
        {
            ...
            this._writer.Write3BitDouble(
                    this._header.PaperSpaceOrthographicTopDOrigin);
            //3BD: PUCSORGBOTTOM
            this._writer.Write3BitDouble(
                    this._header.PaperSpaceOrthographicBottomDOrigin);
            //3BD: PUCSORGLEFT
            this._writer.Write3BitDouble(
                    this._header.PaperSpaceOrthographicLeftDOrigin);
            //3BD: PUCSORGRIGHT
            this._writer.Write3BitDouble(
                    this._header.PaperSpaceOrthographicRightDOrigin);
            //3BD: PUCSORGFRONT
            this._writer.Write3BitDouble(
                    this._header.PaperSpaceOrthographicFrontDOrigin);
            //3BD: PUCSORGBACK
            this._writer.Write3BitDouble(
                    this._header.PaperSpaceOrthographicBackDOrigin);
        }
        ...
        if (this.R2000Plus)
        {
            ...
            //3BD: UCSORGTOP
            this._writer.Write3BitDouble(
                    this._header.ModelSpaceOrthographicTopDOrigin);
            //3BD: UCSORGBOTTOM
            this._writer.Write3BitDouble(
                    this._header.ModelSpaceOrthographicBottomDOrigin);
            //3BD: UCSORGLEFT
            this._writer.Write3BitDouble(
                    this._header.ModelSpaceOrthographicLeftDOrigin);
            //3BD: UCSORGRIGHT
            this._writer.Write3BitDouble(
                    this._header.ModelSpaceOrthographicRightDOrigin);
            //3BD: UCSORGFRONT
            this._writer.Write3BitDouble(
                    this._header.ModelSpaceOrthographicFrontDOrigin);
            //3BD: UCSORGBACK
            this._writer.Write3BitDouble(
                    this._header.ModelSpaceOrthographicBackDOrigin);

            //TV : DIMPOST
            this._writer.WriteVariableText(this._header.DimensionPostFix);
            //TV : DIMAPOST
            this._writer.WriteVariableText(
                    this._header.DimensionAlternateDimensioningSuffix);
        }
        ...
        if (this.R13_14Only)
        {
            ...
            //B : DIMSE1
            this._writer.WriteBit(
                    this._header.DimensionSuppressFirstExtensionLine);
            //B : DIMSE2
            this._writer.WriteBit(
                    this._header.DimensionSuppressSecondExtensionLine);
            //B : DIMALT
            this._writer.WriteBit(
                    this._header.DimensionAlternateUnitDimensioning);
            //B : DIMTOFL
            ...
            //B : DIMSOXD
            this._writer.WriteBit(
                    this._header.DimensionSuppressOutsideExtensions);
            //RC : DIMALTD
            this._writer.WriteByte(
                    (byte) this._header.DimensionAlternateUnitDecimalPlaces);
            //RC : DIMZIN
            this._writer.WriteByte((byte) this._header.DimensionZeroHandling);
            //B : DIMSD1
            this._writer.WriteBit(
                    this._header.DimensionSuppressFirstDimensionLine);
            //B : DIMSD2
            this._writer.WriteBit(
                    this._header.DimensionSuppressSecondDimensionLine);
            //RC : DIMTOLJ
            this._writer.WriteByte(
                    (byte) this._header.DimensionToleranceAlignment);
            //RC : DIMJUST
            this._writer.WriteByte(
                    (byte) this._header.DimensionTextHorizontalAlignment);
            //RC : DIMFIT
            ...
            //RC : DIMTZIN
            this._writer.WriteByte(
                    (byte) this._header.DimensionToleranceZeroHandling);
            //RC: DIMALTZ
            this._writer.WriteByte(
                    (byte) this._header.DimensionAlternateUnitZeroHandling);
            //RC : DIMALTTZ
            this._writer.WriteByte(
                    (byte) this._header
            ...
            //RC : DIMTAD
            this._writer.WriteByte(
                    (byte) this._header.DimensionTextVerticalAlignment);
            //BS : DIMUNIT
            this._writer.WriteBitShort(this._header.DimensionUnit);
            //BS : DIMAUNIT
            this._writer.WriteBitShort(
                    this._header.DimensionAngularDimensionDecimalPlaces);
            //BS : DIMDEC
            this._writer.WriteBitShort(this._header.DimensionDecimalPlaces);
            //BS : DIMTDEC
            this._writer.WriteBitShort(
                    this._header.DimensionToleranceDecimalPlaces);
            //BS : DIMALTU
            this._writer.WriteBitShort(
                    (short) this._header.DimensionAlternateUnitFormat);
            //BS : DIMALTTD
            this._writer.WriteBitShort(
                    this._header.DimensionAlternateUnitToleranceDecimalPlaces);
        ...
        //BD : DIMEXE
        this._writer.WriteBitDouble(
                this._header.DimensionExtensionLineExtension);
        //BD : DIMRND
        ...
        if (this.R2007Plus)
        {
            //BD: DIMFXL
            this._writer.WriteBitDouble(
                    this._header.DimensionFixedExtensionLineLength);
            //BD : DIMJOGANG
            this._writer.WriteBitDouble(
                    this._header
            ...
            //BS : DIMTFILL
            this._writer.WriteBitShort(
                    (short) this._header.DimensionTextBackgroundFillMode);
            //CMC : DIMTFILLCLR
            this._writer.WriteCmColor(
                    this._header.DimensionTextBackgroundColor);
        }
        ...
        if (this.R2000Plus)
        {
            ...
            //BS : DIMTAD
            this._writer.WriteBitShort(
                    (short) this._header.DimensionTextVerticalAlignment);
            //BS : DIMZIN
            this._writer.WriteBitShort(
                    (short) this._header.DimensionZeroHandling);
            //BS : DIMAZIN
            this._writer.WriteBitShort(
                    (short) this._header.DimensionAngularZeroHandling);
        }
        ...
        if (this.R2007Plus)
        {
            //BS: DIMARCSYM
            this._writer.WriteBitShort(
                    (short) this._header.DimensionArcLengthSymbolPosition);
        }
        ...
        //BD : DIMALTF
        this._writer.WriteBitDouble(
                this._header.DimensionAlternateUnitScaleFactor);
        //BD : DIMLFAC
        ...
        if (this.R2000Plus)
        {
            //BD: DIMALTRND
            this._writer.WriteBitDouble(
                    this._header.DimensionAlternateUnitRounding);
            //B : DIMALT
            this._writer.WriteBit(
                    this._header.DimensionAlternateUnitDimensioning);
            //BS : DIMALTD
            this._writer.WriteBitShort(
                    this._header.DimensionAlternateUnitDecimalPlaces);
            //B : DIMTOFL
            this._writer.WriteBit(this._header.DimensionTextOutsideExtensions);
            //B : DIMSAH
            this._writer.WriteBit(this._header.DimensionSeparateArrowBlocks);
        ...
        if (this.R2000Plus)
        {
            ...
            //BS : DIMAUNIT
            this._writer.WriteBitShort(
                    (short) this._header.DimensionAngularUnit);
            //BS : DIMFRAC
            this._writer.WriteBitShort(
                    (short) this._header.DimensionFractionFormat);
            //BS : DIMLUNIT
            this._writer.WriteBitShort(
                    (short) this._header.DimensionLinearUnitFormat);
            //BS : DIMDSEP
            this._writer.WriteBitShort(
                    (short) this._header.DimensionDecimalSeparator);
            //BS : DIMTMOVE
            this._writer.WriteBitShort(
                    (short) this._header.DimensionTextMovement);
            //BS : DIMJUST
            this._writer.WriteBitShort(
                    (short) this._header.DimensionTextHorizontalAlignment);
            //B : DIMSD1
            this._writer.WriteBit(
                    this._header.DimensionSuppressFirstExtensionLine);
            //B : DIMSD2
            ...
            //BS : DIMTOLJ
            this._writer.WriteBitShort(
                    (short) this._header.DimensionToleranceAlignment);
            //BS : DIMTZIN
            this._writer.WriteBitShort(
                    (short) this._header.DimensionToleranceZeroHandling);
            //BS: DIMALTZ
            this._writer.WriteBitShort(
                    (short) this._header.DimensionAlternateUnitZeroHandling);
            //BS : DIMALTTZ
            this._writer.WriteBitShort(
                    (short) this._header
                            .DimensionAlternateUnitToleranceZeroHandling);
            ...
            //BS : DIMATFIT
            this._writer.WriteBitShort(
                    (short) this._header.DimensionDimensionTextArrowFit);
        }
        ...
        if (this.R2007Plus)
        {
            //B: DIMFXLON
            this._writer.WriteBit(
                    this._header.DimensionIsExtensionLineLengthFixed);
        }
        ...
        {
            //B: DIMTXTDIRECTION
            this._writer.WriteBit(this._header.DimensionTextDirection ==
        ...
        if (this.R2000Plus)
        {
            ...
            if (!this._header.DisplayLineWeight) { flags |= 0x200; }
            //XEDIT!(Flags & 0x0400)
            if (!this._header.XEdit) { flags |= 0x400; }
            //EXTNAMES Flags & 0x0800
            if (this._header.ExtendedNames) { flags |= 0x800; }
            //PSTYLEMODE Flags & 0x2000
            if (this._header.PlotStyleMode == 1) { flags |= 0x2000; }
            //OLESTARTUP Flags & 0x4000
            if (this._header.LoadOLEObject) { flags |= 0x4000; }
            ...
            //BS : CEPSNTYPE
            this._writer.WriteBitShort(
                    (short) this._header.CurrentEntityPlotStyle);

            if (this._header.CurrentEntityPlotStyle ==
                EntityPlotStyleType.ByObjectId)
            {
        ...
        if (this.R2004Plus)
        {
            ...
            this._writer.WriteByte(
                    this._header.ExternalReferenceClippingBoundaryType);
            //RC : DIMASSOC
        ...
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._document.PaperSpace);
        //H: BLOCK_RECORD(*MODEL_SPACE)(hard pointer)
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._document.ModelSpace);
        //H: LTYPE(BYLAYER)(hard pointer)
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._document.LineTypes["ByLayer"]);
        //H: LTYPE(BYBLOCK)(hard pointer)
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._document.LineTypes["ByBlock"]);
        //H: LTYPE(CONTINUOUS)(hard pointer)
        this._writer.HandleReference(DwgReferenceType.HardPointer,
                                     this._document.LineTypes["Continuous"]);
        ...
        if (this.R2007Plus)
        {
            ...
            //BD : LOFTANG1
            this._writer.WriteBitDouble(
                    this._header.DraftAngleFirstCrossSection);
            //BD : LOFTANG2
            this._writer.WriteBitDouble(
                    this._header.DraftAngleSecondCrossSection);
            //BD : LOFTMAG1
            this._writer.WriteBitDouble(
                    this._header.DraftMagnitudeFirstCrossSection);
            //BD : LOFTMAG2
            this._writer.WriteBitDouble(
                    this._header.DraftMagnitudeSecondCrossSection);
            //BS : LOFTPARAM
            ...
            //RC : DWFFRAME
            this._writer.WriteByte(
                    (byte) this._header.DwgUnderlayFramesVisibility);
            //RC : DGNFRAME
            this._writer.WriteByte(
                    (byte) this._header.DgnUnderlayFramesVisibility);
...
private
    void writeSizeAndCrc()
    {
        ...
        this._startWriter.WriteBytes(
                DwgSectionDefinition.StartSentinels[SectionName]);

        CRC8StreamHandler crc =
                new CRC8StreamHandler(this._startWriter.Stream, 0xC0C1);
