...
public:
    ...
    */
    ...
    static DateTime FromString(const std::string &fmt, const std::string &str, int &timeZoneDifferential);
    static DateTime FromString(DateFormat fmt, const std::string &str, int &timeZoneDifferential);
