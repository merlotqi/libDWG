...
namespace dwg {
    ...
    DxfTablesSectionWriter::DxfTablesSectionWriter(IDxfStreamWriter *writer, CadDocument *document, CadObjectHolder *objectHolder,
...
std::string DxfTablesSectionWriter::sectionName() const { return std::string(); }
