...
std::ostream *DwgMergedStreamWriter::stream()
{
    ...
    Encoding DwgMergedStreamWriter::encoding() { return Encoding(CodePage::Utf8); }

    IDwgStreamWriter *DwgMergedStreamWriter::main() const { return _main; }

    long long DwgMergedStreamWriter::positionInBits() const { return 0LL; }

    long long DwgMergedStreamWriter::savedPositionInBits() const { return 0LL; }
