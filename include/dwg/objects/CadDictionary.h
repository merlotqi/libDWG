...
public:
    ...
    public:
        using value_type = const NonGraphicalObject *;
        using reference = const NonGraphicalObject *&;
        using pointer = const NonGraphicalObject **;
        using difference_type = std::ptrdiff_t;
        using iterator_category = std::forward_iterator_tag;

        explicit const_value_iterator(const_iterator i) : it(i) {}
    ...
    {
        return value_iterator(_entries.begin());
    }
    value_iterator value_end()
    {
        return value_iterator(_entries.end());
    }

    const_value_iterator value_begin() const
    {
        return const_value_iterator(_entries.begin());
    }
    const_value_iterator value_end() const
    {
        return const_value_iterator(_entries.end());
    }
