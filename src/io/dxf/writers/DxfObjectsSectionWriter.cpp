...
namespace dwg {
    ...
    DxfObjectsSectionWriter::DxfObjectsSectionWriter(IDxfStreamWriter *writer, CadDocument *document, CadObjectHolder *objectHolder,
...
std::string DxfObjectsSectionWriter::sectionName() const { return std::string(); }
