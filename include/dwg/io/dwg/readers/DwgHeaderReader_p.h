...
{
public:
    DwgHeaderReader(ACadVersion version, IDwgStreamReader *sreader, CadHeader *header);

    ~DwgHeaderReader();

    std::string sectionName() const;

    void read(int acadMaintenanceVersion, DwgHeaderHandlesCollection *objectPointers);
