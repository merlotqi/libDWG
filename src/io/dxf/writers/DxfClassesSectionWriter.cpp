...
namespace dwg {
    ...
    DxfClassesSectionWriter::DxfClassesSectionWriter(IDxfStreamWriter *writer, CadDocument *document, CadObjectHolder *objectHolder,
...
std::string DxfClassesSectionWriter::sectionName() const { return std::string(); }
