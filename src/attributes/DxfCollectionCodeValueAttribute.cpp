...
#include <dwg/attributes/DxfCollectionCodeValueAttribute_p.h>
...
std::vector<DxfCode> DxfCollectionCodeValueAttribute::valueCodes() const
{
    return _valueCodes;
}

DxfReferenceType DxfCollectionCodeValueAttribute::referenceType() const
{
