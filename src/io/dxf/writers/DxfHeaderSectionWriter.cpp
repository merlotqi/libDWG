...
namespace dwg {
    ...
    DxfHeaderSectionWriter::DxfHeaderSectionWriter(IDxfStreamWriter *writer, CadDocument *document, CadObjectHolder *objectHolder,
...
std::string DxfHeaderSectionWriter::sectionName() const { return std::string(); }
