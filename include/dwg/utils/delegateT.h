...
public:
  ...
  bool
  isType(const std::type_info& _type) override
  {
  ...
  bool
  compare(DelegateT<Return, Args...>* _delegate) const override
  {
    if (!_delegate
...
public:
  ...
  compare(DelegateT<Return, Args...>* _delegate) const override
  {
    ...
    auto* cast = dynamic_cast<ClassMemberDelegateT<T, Return (T::*)(Args...)>*>(
        _delegate);
...
inline StaticDelegateT<Fun>*
new_delegate(Fun _fun)
{
  return new StaticDelegateT<Fun>(_fun);
}

template <typename T, typename Fun>
inline ClassMemberDelegateT<T, Fun>*
new_delegate(T* _object, Fun _fun)
{
